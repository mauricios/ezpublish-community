server {
    ...
    location / {
        location ~ ^/(index|index_(rest|cluster|treemenu_tags))\.php(/|$) {
            ...
            # Defaults to bootstrap.php.cache, or autoload.php in debug, supported on 5.4/2015.01 and higher
            ...
            #! Not supported as of 5.4/2015.01, use CUSTOM_CLASSLOADER_FILE instead for this.
            ...
            # Defaults to to use "EzPublishCache", supported on 5.4/2015.01 and higher
